...
RUN echo 2.113 > /usr/share/jenkins/ref/jenkins.install.UpgradeWizard.state
RUN echo 2.113 > /usr/share/jenkins/ref/jenkins.install.InstallUtil.lastExecVersion
