...
RUN echo 2.101 > /usr/share/jenkins/ref/jenkins.install.UpgradeWizard.state
RUN echo 2.101 > /usr/share/jenkins/ref/jenkins.install.InstallUtil.lastExecVersion
