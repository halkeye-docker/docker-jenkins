...
RUN echo 2.98 > /usr/share/jenkins/ref/jenkins.install.UpgradeWizard.state
RUN echo 2.98 > /usr/share/jenkins/ref/jenkins.install.InstallUtil.lastExecVersion
